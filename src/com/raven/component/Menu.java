...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        listMenu1.addItem(new Model_Menu("", "Flight", Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("", "", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("1", "Add Flight", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("2", "Edit Flight", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "View Flights", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
     
        listMenu1.addItem(new Model_Menu("", "Registration", Model_Menu.MenuType.TITLE));
        listMenu1.addItem(new Model_Menu("", "", Model_Menu.MenuType.EMPTY));
        listMenu1.addItem(new Model_Menu("4", "Add Member", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Edit Member", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6", "Delete Member", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("", " ", Model_Menu.MenuType.EMPTY));
